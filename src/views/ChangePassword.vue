  ...
  <div>
    ...
    <div class="field">
          ...
          <div class="control has-icons-right">
            ...
            <span class="icon is-small is-right">
              ...
              />
              <font-awesome-icon
                v-else-if="passwordClass && (!isCorrectPassword || !newPassword)"
    ...
    <div class="field">
          ...
          <div class="control has-icons-right">
            ...
            <span class="icon is-small is-right">
              <font-awesome-icon
                v-if="reNewPassword && rePasswordClass && isCorrectRePassword"
                icon="check"
              />
              <font-awesome-icon
                v-else-if="
                  rePasswordClass && (!isCorrectRePassword || !reNewPassword)
                "
                icon="exclamation-triangle"
              />
            </span>
